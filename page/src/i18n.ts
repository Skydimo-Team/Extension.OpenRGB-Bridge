...
const I18N: Record<string, Translations> = {
  ...
  'ru': {
    ...
    loading: 'Загрузка…',
    no_devices_title: 'Устройства не найдены',
    no_devices_desc: 'Убедитесь, что OpenRGB запущен и сервер SDK включён.',
    no_match: 'Нет устройств, подходящих под этот фильтр',
    devices_stats: '{total} устройств · {enabled} включено · {disabled} отключено',
    device_type: 'Тип',
    device_vendor: 'Производитель',
    device_location: 'Расположение',
    device_zones: '{count} зон',
    ...
    openrgb_not_running: 'OpenRGB не запущен',
    protocol_version: 'Версия протокола v{version}',
  },
  'tr': {
    title: 'OpenRGB Köprüsü',
    connected: 'Bağlı',
    ...
    loading: 'Yükleniyor…',
    no_devices_title: 'Cihaz bulunamadı',
    no_devices_desc: 'OpenRGB’nin çalıştığından ve SDK sunucusunun etkin olduğundan emin olun.',
    no_match: 'Bu filtreyle eşleşen cihaz yok',
    devices_stats: '{total} cihaz · {enabled} etkin · {disabled} devre dışı',
    device_type: 'Tür',
    device_vendor: 'Üretici',
    device_location: 'Konum',
    device_zones: '{count} bölge',
    device_leds: '{count} LED',
    ...
    enabled_label: 'Etkin',
    openrgb_not_running: 'OpenRGB çalışmıyor',
    protocol_version: 'Protokol sürümü v{version}',
  },
}
